...
describe("Polynomial field", () => {
  it("Should compute a multiplication", () => {
    ...
    assert(
      PF.eq(res, [PF.F.e(1), PF.F.e(4), PF.F.e(10), PF.F.e(12), PF.F.e(9)])
    );
  });
  ...
  it("Should div random big", () => {
    ...
    for (let i = 0; i < 1000; i++)
      a.push(PF.F.e(Math.floor(Math.random() * 100000) - 500000));
    for (let i = 0; i < 900; i++)
      b.push(PF.F.e(Math.floor(Math.random() * 100000) - 500000));
